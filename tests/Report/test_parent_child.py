...
class TestHostParentChild(OP5Fixture):
    ...
    def test_host_parent_child_logic(self):
        ...
        # as there is no HTTP service available on it and OP5 should determin
        # it as down.
        ...
        # Although the child host is down but since the parent
        # host is up, by reachability logic, it will be considered down
        # only.

        # Lets bring the parent host down and then verify that whether the
        # child host goes unreachable instead of down
        ...
        # Now in the next check for the child host, which is already down
        # OP5 is going to define it as unreachable since the parent
